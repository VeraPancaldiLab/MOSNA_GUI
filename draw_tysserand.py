...
def main():
    ...
    if config_file['standard']['saving']:
        ...
        IMC_cell_pos.to_parquet("./pandas_data/IMC_cell_pos.parquet")
        IMC_markers.to_parquet("./pandas_data/IMC_markers.parquet")
        IMC_sample_cell.to_parquet("./pandas_data/IMC_sample_cell.parquet")

        IF_cell_pos.to_parquet("./pandas_data/IF_cell_pos.parquet")
        IF_markers.to_parquet("./pandas_data/IF_markers.parquet")
        IF_sample_cell.to_parquet("./pandas_data/IF_sample_cell.parquet")
        print('DONE')
